angular.module('Headlines')
  .controller('BusinessCtrl', ['$scope', '$routeParams', function($scope, $routeParams) {

$scope.articles = [];

$scope.pageHead = "Business";

$scope.apiLink = 'http://api.feedzilla.com/v1/categories/22/articles.json'
