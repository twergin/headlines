angular.module('Headlines')
  .controller('SportsCtrl', ['$scope', '$routeParams', function($scope, $routeParams) {

$scope.articles = [];

$scope.pageHead = "Sports";

$scope.apiLink = 'http://api.feedzilla.com/v1/categories/27/articles.json'
