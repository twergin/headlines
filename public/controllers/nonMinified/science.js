angular.module('Headlines')
  .controller('ScienceCtrl', ['$scope', '$routeParams', function($scope, $routeParams) {

$scope.articles = [];

$scope.pageHead = "Science";

$scope.apiLink = 'http://api.feedzilla.com/v1/categories/8/articles.json'
